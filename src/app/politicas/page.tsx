...
export default function PoliticasPage() {
  ...
  const content = {
    ...
    termos: {
      ...
      text: `Na Komode, queremos garantir sua completa satisfação com sua compra. Se você não estiver totalmente satisfeito com seu produto, estamos aqui para ajudar.\n\n1. **Política de Devolução:**\nAceitamos devoluções dentro de [número de dias] dias a partir da data de recebimento do produto.\n\n Para ser elegível para devolução, o item deve estar em sua condição original, sem sinais de uso ou danos.\n\n2. **Processo de Devolução:**\nPara iniciar o processo de devolução, entre em contato conosco para obter um número de autorização de devolução. Você será responsável pelo custo do envio do produto de volta para nós, a menos que o motivo da devolução seja devido a um erro nosso.\n\n3. **Reembolsos:**\nAssim que recebermos e examinarmos o item devolvido, iniciaremos o processo de reembolso para o método de pagamento original. O reembolso pode levar alguns dias para aparecer em sua conta, dependendo do seu provedor de serviços financeiros.\n\n4. **Trocas:**\nSe preferir trocar seu item por outro, entre em contato conosco para que possamos organizar a troca. Você será responsável pelo custo do envio do item de volta para nós, a menos que o motivo da troca seja devido a um erro nosso.\n\n5. **Itens Não Elegíveis para Devolução:**\nAlguns itens, como produtos personalizados ou itens em liquidação, podem não ser elegíveis para devolução. Consulte a descrição do produto antes de fazer sua compra.\n\nEsperamos que você fique satisfeito com sua compra na Komode, mas se surgir algum problema, não hesite em nos contatar para que possamos resolver rapidamente. Sua satisfação é nossa prioridade.`,
    },
    duvidas: {
      title: 'Termo de Garantia',
      text: `Na Komode, temos orgulho da qualidade dos nossos produtos e queremos garantir a sua satisfação. Oferecemos garantia para todos os produtos que vendemos, para que você possa fazer suas compras com confiança.

1. **Período de Garantia:**
   Cada produto possui um período de garantia específico, que varia de acordo com o tipo de produto e o fabricante. Consulte a página do produto ou entre em contato conosco para obter informações detalhadas sobre o período de garantia.

2. **Cobertura da Garantia:**
   A garantia cobre defeitos de fabricação e problemas relacionados ao desempenho normal do produto. Se você encontrar qualquer problema coberto pela garantia durante o período especificado, entre em contato conosco para solicitar assistência.

3. **Exclusões da Garantia:**
   A garantia não cobre danos causados por uso indevido, negligência, acidentes, modificações não autorizadas ou desgaste normal do produto. Qualquer alteração feita no produto por terceiros que não sejam autorizados por nós pode invalidar a garantia.

4. **Processo de Reclamação:**
   Se você precisar acionar a garantia, entre em contato conosco o mais rápido possível. Será necessário fornecer informações detalhadas sobre o problema, juntamente com evidências fotográficas, se aplicável. Faremos o possível para resolver o problema de forma rápida e eficiente.

Estamos comprometidos em fornecer produtos de alta qualidade e garantir sua satisfação. Se você tiver alguma dúvida sobre nossa política de garantia, não hesite em entrar em contato conosco.
`,
    },
    entregas: {
