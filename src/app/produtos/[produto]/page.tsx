        ...
        <div className={style.descricao}>
          ...
          <p>
            * As imagens dos produtos são meramente ilustrativas. As cores podem
            sofrer variações dependendo da luminosidade, tipo de câmera ou mesmo
            da visualização das imagens em computadores, notebooks com telas LCD
            ou LED, tablets ou smartphones, dependendo da quantidade de pixels,
            podendo deixar as imagens com cores mais opacas ou cores mais
            vibrantes.
          </p>
        </div>
      </div>
